      ...
      <div className="hero__grid">
        <div className="hero__content">
          ...
          <div aria-label="Ações principais" className="hero__actions">
            <a className="hero-cta hero-cta--primary" href={createWhatsappUrl(WHATSAPP_MESSAGES.budget)} rel="noopener noreferrer" target="_blank">
          ...
          <section className="hero__proof" aria-label="Avaliações no Google">
            ...
            <div className="hero__proof-google">
              ...
              <div className="hero__proof-copy">
                <strong>
                  Mais de {COMPANY.reviews.count} avaliações
                </strong>
                <div className="hero__proof-rating" aria-label={`Avaliação ${COMPANY.reviews.ratingLabel} de 5`}>
                  <span className="hero__proof-stars" aria-hidden="true">
                    ★★★★★
                  </span>
                  <span>
                    {COMPANY.reviews.ratingLabel} de 5
                  </span>
                </div>
                <small>
        ...
        <div aria-label={`Profissional da ${COMPANY.name}`} className="hero__visual">
          <img alt={`Profissional da ${COMPANY.name} durante atendimento`} className="hero__portrait" fetchPriority="high" height="2048" src="/assets/images/hero/fritz-hero.webp" width="1675" />
        </div>
      </div>
    </section>
  );
